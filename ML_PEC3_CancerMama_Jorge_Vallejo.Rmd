...
```{r variable ranges boxplot, fig.height=6, fig.width=5, out.width='50%'}
# par(mfcol = c(1, 2))
...
Antes de analizar el set de datos con los algoritmos de aprendizaje automático, primero es necesario  repartir los datos para generar grupos de entrenamiento y de evaluación. En esta caso he decidido dividr el set al azar en un grupo de entrenamiento (2/3 de las observaciones), y un grupo de evaluación (1/3 de las observaciones).
